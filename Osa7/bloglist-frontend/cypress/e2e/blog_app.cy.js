describe('Blog app', function () {
  ...
  describe('When logged in', function () {
    ...
    it('A blog can be created', function () {
      ...
      cy.get('#url').type(
        'https://fullstackopen.com/osa5/end_to_end_testaus#tehtavat-5-17-5-23'
      )
    ...
    describe('and blog exists', function () {
      beforeEach(function () {
        ...
        cy.contains('cypress test blog unknown').contains('view').click()
      })
      ...
      it('blogs are sorted by likes', function () {
        ...
        cy.contains('cypress test blog').contains('view').click()
